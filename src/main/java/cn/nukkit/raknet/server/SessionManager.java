...
public class SessionManager {
    ...
    public SessionManager(RakNetServer server, Socket socket) throws Exception {
        this.server = server;
        this.socket = socket;
    ...
    public int getPort() {
        return this.server.getAddress().port;
    }
